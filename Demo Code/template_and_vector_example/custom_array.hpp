/*
	...
	For our purposes we are using this naming convention to mean that the file contains both traditional header information as well as function definitions (that would usually be placed in a corresponding .cpp file).
	Since we are working with a template class, C++ has certain requirements, one of which is that the template code needs to be contained all in one file.
